...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.tanishka.store";
const DELETE_TASK_API_BASE_URL = "http://delete-task-api.tanishka.store";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.tanishka.store";
